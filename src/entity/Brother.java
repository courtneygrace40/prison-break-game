...
public class Brother extends Entity{
	...
	public Brother(Modify_Frame mf, KeyHandler kh) {
	...
	public void getPlayerImage() {
		try{
			front = ImageIO.read(getClass().getResourceAsStream("/player/TheBrother_Front.png"));
			back = ImageIO.read(getClass().getResourceAsStream("/player/TheBrother_Back.png"));
		}
		catch(IOException e) {
			e.printStackTrace();
		}
